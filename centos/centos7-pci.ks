...
# I hope you have space! Also... if you are using Oracle Service Bus or weblogic (shudder)
# You will destroy /var/log at this point. You may want to internally discuss this with your team.
...
# It will also allow you to tell people who are developers to knock their shit off if they are trying anything funny.
...
# This list is generated running the following command:
...
# It's kind of a silly example below, but you get the idea.
